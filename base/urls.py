...
urlpatterns = [    path('registro/',PaginaRegistro.as_view(),name='registro_iglesia'),
               ...
               path('iglesias/nueva/', IglesiaCreateView.as_view(), name='iglesia_create_temp'),
               path('iglesias/editar/<int:pk>/', IglesiaUpdateView.as_view(), name='iglesia_update_temp'),
               ...
               path('bienvenida/<str:cod>/', VerBienvenidaView.as_view(), name='ver-bienvenida'),
